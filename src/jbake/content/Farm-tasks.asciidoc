...
Provided that you already learned link:Multiple-web-apps-tutorial.html[multiple web apps tutorial], now you can systematically learn all about farm tasks.
