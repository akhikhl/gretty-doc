...
| same as link:Gretty-configuration.html#Server-specific-properties[server-specific properties of gretty configuration]

| web-app-specific properties
|
| all properties are null by default
| same as link:Gretty-configuration.html#Web-app-specific-properties[web-app specific properties of gretty configuration]
...
| integer
| null
| same as in link:Gretty-configuration.html#Server-specific-properties[server-specific properties of gretty configuration]
|===
