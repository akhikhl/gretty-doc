...
* link:Gretty-configuration.html#fastReload[fastReload] boolean.
...
* link:Gretty-configuration.html#fastReload[fastReload] function(String) or function(java.io.File).
The specified directory or file is added to fast-reloaded resources.

* link:Gretty-configuration.html#fastReload[fastReload] - function(Map).
...
* link:Gretty-configuration.html#fastReload[fastReload] property is set to false.
