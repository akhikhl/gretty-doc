...
link:Gretty-configuration.html#port[project.gretty.port]. Defines TCP-port
...
link:Gretty-configuration.html#statusPort[project.gretty.statusPort]. Defines
TCP-port used by Jetty process to send status to Gretty.
* `contextPath` - string, optional, default is
link:Gretty-configuration.html#contextPath[project.gretty.contextPath].
...
link:Gretty-configuration.html#jettyXmlFile[project.gretty.jettyXmlFile].
...
link:Gretty-configuration.html#jettyEnvXmlFile[project.gretty.jettyEnvXmlFile].
...
link:Gretty-configuration.html#scanInterval[project.gretty.scanInterval].
...
link:Gretty-configuration.html#logbackConfigFile[project.gretty.logbackConfigFile].
...
link:Gretty-configuration.html#loggingLevel[project.gretty.loggingLevel].
Defines slf4j logging-level for jetty process. See more information in
chapter Logging.
* `consoleLogEnabled` - boolean, optional, default is
link:Gretty-configuration.html#consoleLogEnabled[project.gretty.consoleLogEnabled].
