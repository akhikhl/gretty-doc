...
TIP: You can even invoke tasks for different farms in parallel, provided that each farm gets distinct set of TCP-ports (see more information on farm TCP-ports link:Farm-configuration.html#_server_specific_properties_catalog[here].
