...
link:Switching-between-Jetty-and-servlet-API-versions.html[Switching between jetty and servlet-API versions] +
...
link:Combining-web-app-and-farm.html[Combining web-app and farm] +
...
link:Publishing-gretty-to-sonatype-and-bintray.html[Publishing gretty to sonatype and bintray]
