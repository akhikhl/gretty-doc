...
The object called jettyBeforeIntegrationTest is actually an instance of link:Gretty-task-classes.html#jettybeforeintegrationtesttask[JettyBeforeIntegrationTestTask] class, created and configured for you by Gretty. You can instantiate or even extend this class on your own:
