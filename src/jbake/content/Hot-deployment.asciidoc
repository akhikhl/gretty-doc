...
* link:Gretty-configuration.html#scanInterval[scanInterval] defines scan interval, in seconds.

* link:Gretty-configuration.html#scanDir[scanDir] defines one or more
...
* link:Gretty-configuration.html#onScan[onScan] adds a closure to be called
...
* link:Gretty-configuration.html#onScanFileChanged[onScanFilesChanged]
...
* link:Gretty-configuration.html#scanInterval[scanInterval] is set to zero,
