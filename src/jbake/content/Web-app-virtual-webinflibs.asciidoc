...
Gretty sources contain https://github.com/akhikhl/gretty/tree/master/examples/gretty-taglib-example[example program] demonstrating use of virtual WEB-INF/lib entries. You can run integration tests against this example program by invoking integrationTestAllContainers task.
